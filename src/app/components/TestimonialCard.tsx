  ...
  return (
    <div className="border border-gray-800 bg-gray-950 rounded-md" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
      <div className="p-4">
        ...
        <p className="text-sm text-gray-400" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">{content}</p>
        <div className="flex justify-center items-center gap-3 my-4" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700">
