...
export default function Home() {
  ...
  return (
    <div className="w-full p-4 md:p-10">
      ...
      <h3 className="text-[20px] text-gray-400" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">I craft robust, scalable, and high-performance backend solutions that fuel exceptional user experiences. </h3>
